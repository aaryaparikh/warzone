...
public class Build2DemoTest {
    ...
    public void testDriverDemoStart() {
        // Simulate user input
    	String simulatedInput = "next" + System.lineSeparator() + "next" + System.lineSeparator() + "end" + System.lineSeparator() + "end" + System.lineSeparator();
    ...
    public void testDriverDemoShowmap() {
        // Simulate user input
    	String simulatedInput = "next" + System.lineSeparator() + "showmap" + System.lineSeparator() + "next" + System.lineSeparator() + "end" + System.lineSeparator() + "end" + System.lineSeparator();
        System.setIn(new ByteArrayInputStream(simulatedInput.getBytes()));
