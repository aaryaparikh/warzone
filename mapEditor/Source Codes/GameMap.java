...
class GameMap {
    ...
    public void removeContinent(String continentID) {
        continents.removeIf(continent -> continent.getName().equals(continentID));
    }
    ...
    public void showMap() {
        ...
        for (Continent continent : continents) {
            System.out.println("Continent: " + continent.getName() + " (Value: " + continent.getControlValue() + ")");
    ...
    public void saveMapToFile(String filename) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(filename))) {
            for (Continent continent : continents) {
                ...
                writer.println("ContinentName=" + continent.getName());
            ...
            for (Country country : countries) {
                ...
                writer.println("ContinentName=" + country.getContinent().getName());
